...
import { Mail, Lock, Loader2, AlertCircle, CheckCircle2 } from 'lucide-vue-next';
...
const handleLogin = async () => {
  ...
  try {
    ...
    errorMessage.value = e.response?.data?.message || 'Invalid credentials or unverified email.';
  } finally {
    loading.value = false;
  }
};
